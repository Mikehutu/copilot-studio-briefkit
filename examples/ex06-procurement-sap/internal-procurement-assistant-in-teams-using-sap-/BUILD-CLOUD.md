# Build in cloud — Internal procurement assistant in Teams using SAP for purcha
...
### 1. Create agent
- Create → New agent → Name: `Internal procurement assistant in Teams using SAP for purcha`.
...
### 5. Tools
- Configure: Connector actions for SAP (see connector reference)
