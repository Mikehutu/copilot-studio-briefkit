# Build in cloud — Internal HR bot for PTO requests with Workday and SharePoint
...
### 1. Create agent
- Create → New agent → Name: `Internal HR bot for PTO requests with Workday and SharePoint`.
