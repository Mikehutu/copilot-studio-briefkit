# Design — Internal finance agent in Teams for invoice handling and app
...
## Brief
Internal finance agent in Teams for invoice handling and approval workflow with Dataverse and Outlook for email triage, Europe.
