# Build in cloud — Internal finance agent in Teams for invoice handling and app
...
### 1. Create agent
- Create → New agent → Name: `Internal finance agent in Teams for invoice handling and app`.
...
- Configure: Connector actions for Outlook (see connector reference)
- Configure: Connector actions for Dataverse (see connector reference)
