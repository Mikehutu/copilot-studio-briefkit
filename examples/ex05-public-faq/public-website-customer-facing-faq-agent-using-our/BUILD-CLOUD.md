# Build in cloud — Public website customer-facing FAQ agent using our public we
...
### 1. Create agent
- Create → New agent → Name: `Public website customer-facing FAQ agent using our public we`.
...
### 2. Authentication
- Settings → Security → Authentication → **Authenticate manually (Entra or OAuth2) — do NOT use No authentication for personal data**.
...
### 4. Knowledge
- Add knowledge: **Public website** (Knowledge tab).
...
### 5. Tools
- Configure: None beyond generative answers
...
### 7. Channels
- Enable channel: **Custom website / Direct Line**
