# Design — Internal sales assistant in Teams using Salesforce for custo
...
## Brief
Internal sales assistant in Teams using Salesforce for customer data and order status, with scheduling and reporting.
