# Build in cloud — Internal sales assistant in Teams using Salesforce for custo
...
### 1. Create agent
- Create → New agent → Name: `Internal sales assistant in Teams using Salesforce for custo`.
