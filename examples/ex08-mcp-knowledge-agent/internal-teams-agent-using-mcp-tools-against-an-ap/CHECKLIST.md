# Go-live checklist — Internal Teams agent using MCP tools against an approved ser

- [ ] EU environment region confirmed
- [ ] Auth configured and tested (Authenticate with Microsoft (Entra via Teams/M365))
...
- [ ] Missing brief fields resolved: n/a
