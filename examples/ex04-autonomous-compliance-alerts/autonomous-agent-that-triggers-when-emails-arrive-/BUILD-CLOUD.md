# Build in cloud — Autonomous agent that triggers when emails arrive and create
...
### 1. Create agent
- Create → New agent → Name: `Autonomous agent that triggers when emails arrive and create`.
...
- Configure: Event trigger (email / Dataverse / schedule / file)
- Configure: Human-in-the-loop approval for high-risk actions
