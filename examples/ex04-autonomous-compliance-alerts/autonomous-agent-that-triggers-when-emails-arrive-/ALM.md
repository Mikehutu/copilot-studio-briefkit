# ALM — Autonomous agent that triggers when emails arrive and create
...
## Tier note
Delivery tier for this design: **Tier 4 Autonomous/CUA** — ALM mandatory for production at Tier 2+.
