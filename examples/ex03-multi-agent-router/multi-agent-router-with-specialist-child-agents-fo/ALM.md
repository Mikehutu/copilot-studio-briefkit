# ALM — Multi-agent router with specialist child agents for IT HR an
...
## Tier note
Delivery tier for this design: **Tier 5 Multi-agent** — ALM mandatory for production at Tier 2+.
