# Capability tiers (enterprise delivery model)

Prefer the **lowest viable tier**. Official feature docs win over marketing catalogs.

## Tier 1 — Knowledge / FAQ
Knowledge only (SharePoint, documents, public websites, Dataverse, enterprise search connectors). No business write-actions.
